 ...
 * Generated for Laravel 7.15.0 on 2020-07-10 09:25:19.
 *
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|Ingredient[]|Ingredient create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|Ingredient[]|Ingredient make($attributes = [])
     */
    class IngredientFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|MeasureUnit[]|MeasureUnit create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|MeasureUnit[]|MeasureUnit make($attributes = [])
     */
    class MeasureUnitFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|RecipeCategory[]|RecipeCategory create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|RecipeCategory[]|RecipeCategory make($attributes = [])
     */
    class RecipeCategoryFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|Recipe[]|Recipe create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|Recipe[]|Recipe make($attributes = [])
     */
    class RecipeFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|RecipeIngredient[]|RecipeIngredient create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|RecipeIngredient[]|RecipeIngredient make($attributes = [])
     */
    class RecipeIngredientFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|RecipeStep[]|RecipeStep create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|RecipeStep[]|RecipeStep make($attributes = [])
     */
    class RecipeStepFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
